...
export const translations = {
    en: {
        ...
        solverDpm3m: 'DPM++ 3M (3rd order, same cost)',
        ...
        solverDpm3mDesc: 'Uses two previous velocities for 3rd-order accuracy at no extra cost. Best multistep quality.',
        ...
        inferMethodTooltip: 'Euler: 1st order, fastest. Heun: 2nd order, more accurate but 2× cost. DPM++ 2M: 2nd order using velocity history, no extra cost. DPM++ 3M: 3rd order using two-step velocity history, no extra cost. RK4: 4th order, highest precision but 4× cost.',
        ...
        taskDescAutoWrite: 'Describe your song — the AI handles style, BPM, key, and metadata. You provide lyrics.',
    ...
    zh: {
        ...
        taskDescAutoWrite: '描述你想要的歌曲，AI 将为你生成风格和元数据。你提供歌词。',
    ...
    ja: {
        ...
        taskDescAutoWrite: '曲を説明すると、AIがスタイルとメタデータを自動生成します。歌詞はあなたが入力します。',
    ...
    ko: {
        ...
        taskDescAutoWrite: '노래를 설명하면 AI가 스타일과 메타데이터를 자동으로 생성합니다. 가사는 직접 입력하세요.',
